...
import os
from Training_page import Train_class
...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #first Image
        img = Image.open(r"Images\sati.jpg")
        ...
        #Third Image
        img2 = Image.open(r"Images\sati.jpg")
        ...
        b1_1 = Button(bg_img, text="Face Recognize", command=self.face_data, cursor="hand2", font=("times new roman", 15, "bold"), bg="darkblue", fg="white")
        ...
        #Train Image Button
        img8 = Image.open(r"Images\training.jpg")
        ...
        b1_1 = Button(bg_img, text="Train Images", command=self.train_data, cursor="hand2", font=("times new roman", 15, "bold"), bg="darkblue", fg="white")
        ...
        b1_1 = Button(bg_img, text="Developer", command=self.dev_data, cursor="hand2", font=("times new roman", 15, "bold"), bg="darkblue", fg="white")
    ...
    def student_details(self):
        ...
        self.app = Student_class(self.new_window)

    def train_data(self):
        self.new_window = Toplevel(self.root)
        self.app = Train_class(self.new_window)
